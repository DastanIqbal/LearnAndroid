...
#define FFMPEG_CONFIGURATION "--prefix=/mnt/01D1ABAF100032D0/Tools/ffmpeg/n4.0-39-gda39990/build/arm64-v8a --target-os=android --arch=arm64 --enable-jni --enable-mediacodec --disable-asm --cross-prefix=/mnt/01D1ABAF100032D0/Tools/android-ndk-r14b/toolchains/aarch64-linux-android-4.9/prebuilt/linux-x86_64/bin/aarch64-linux-android- --enable-cross-compile --sysroot=/mnt/01D1ABAF100032D0/Tools/android-ndk-r14b/platforms/android-21/arch-arm64/ --pkg-config=/usr/bin/pkg-config --pkg-config-flags=--static --enable-pic --enable-small --enable-gpl --enable-nonfree --disable-shared --enable-static --enable-ffmpeg --disable-ffplay --disable-ffprobe --disable-protocols --enable-protocol='file,concat' --disable-demuxers --disable-muxers --enable-demuxer='concat,aac,avi,dnxhd,gif,h261,h263,h264,image2,matroska,webm,mov,mp2,mp3,mp4,mpeg,srt,gif,image2,image2pipe,mjpeg,mpegts' --enable-muxer='concat,dnxhd,gif,image2,matroska,webm,mov,mp2,mp3,mp4,mpeg,srt,gif,image2,image2pipe,mjpeg,mpegts' --disable-encoders --disable-decoders --enable-encoder='pcm_u8,aac,dnxhd,gif,libx264,libx264rgb,mpeg4,png,mjpeg,gif,srt,mp2' --enable-decoder='pcm_u8,aac,aac_at,aac_fixed,aac_latm,dnxhd,h261,h263,h263i,h263p,h264,h264_mediacodec,vp8,vp9,hevc,mp2,mp3,vorbis,mpeg4,mpeg4_mediacodec,png,mjpeg,gif,pcm_s16le,pcm_s16be,srt,rawvideo' --disable-libshine --disable-libmp3lame --disable-libopus --disable-libvorbis --enable-libx264 --disable-libfdk-aac --enable-bsf=aac_adtstoasc --disable-doc"
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define CONFIG_THIS_YEAR 2018
#define FFMPEG_DATADIR "/mnt/01D1ABAF100032D0/Tools/ffmpeg/n4.0-39-gda39990/build/arm64-v8a/share/ffmpeg"
#define AVCONV_DATADIR "/mnt/01D1ABAF100032D0/Tools/ffmpeg/n4.0-39-gda39990/build/arm64-v8a/share/ffmpeg"
