...
#define FFMPEG_CONFIGURATION "--prefix=/mnt/01D1ABAF100032D0/Tools/ffmpeg/n4.0-39-gda39990/build/x86 --target-os=android --arch=x86 --disable-asm --cross-prefix=/mnt/01D1ABAF100032D0/Tools/android-ndk-r14b/toolchains/x86-4.9/prebuilt/linux-x86_64/bin/i686-linux-android- --enable-cross-compile --sysroot=/mnt/01D1ABAF100032D0/Tools/android-ndk-r14b/platforms/android-16/arch-x86/ --pkg-config=/usr/bin/pkg-config --pkg-config-flags=--static --enable-jni --enable-mediacodec --enable-pic --enable-small --enable-gpl --enable-nonfree --disable-shared --enable-static --enable-ffmpeg --disable-ffplay --disable-ffprobe --disable-protocols --enable-protocol='file,pipe' --disable-demuxers --disable-muxers --enable-demuxer='aac,avi,dnxhd,flac,flv,gif,h261,h263,h264,image2,matroska,webm,mov,mp3,mp4,mpeg,ogg,srt,wav,webvtt,gif,image2,image2pipe,mjpeg' --enable-muxer='3gp,dnxhd,flac,flv,gif,image2,matroska,webm,mov,mp3,mp4,mpeg,ogg,opus,srt,wav,webvtt,ipod,gif,image2,image2pipe,mjpeg' --disable-encoders --disable-decoders --enable-encoder='aac,dnxhd,flac,flv,gif,libmp3lame,libshine,libx264,libx264rgb,mpeg4,png,mjpeg,gif,srt,subrip,webvtt' --enable-decoder='aac,aac_at,aac_fixed,aac_latm,dnxhd,flac,flv,h261,h263,h263i,h263p,h264,h264_mediacodec,mp3,mpeg4,mpeg4_mediacodec,wavpack,png,mjpeg,gif,pcm_s16le,pcm_s16be,rawvideo,srt,webvtt' --disable-libshine --disable-libmp3lame --disable-libopus --disable-libvorbis --enable-libx264 --disable-libfdk-aac --enable-bsf=aac_adtstoasc --disable-doc --disable-asm"
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define CONFIG_THIS_YEAR 2018
#define FFMPEG_DATADIR "/mnt/01D1ABAF100032D0/Tools/ffmpeg/n4.0-39-gda39990/build/x86/share/ffmpeg"
#define AVCONV_DATADIR "/mnt/01D1ABAF100032D0/Tools/ffmpeg/n4.0-39-gda39990/build/x86/share/ffmpeg"
