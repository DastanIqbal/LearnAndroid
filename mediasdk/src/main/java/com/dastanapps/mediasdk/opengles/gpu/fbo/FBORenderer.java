...
public class FBORenderer {
    ...
    private IBitmapCache mBitmapCache = LruBitmapCache.getSingleInstance();
    ...
    public FBORenderer(GLSurfaceView view) {
        ...
        paths.addAll(Utils.convert(view.getContext(), "lear"));
        paths.addAll(Utils.convert(view.getContext(), "snow"));
    }
    ...
    void RenderToTexture() {
        ...
        long position = (currentTime - mStartTime) % 2000;

        int i = Math.round((paths.size() - 1) * 1.0f / 2000 * position);
        ...
        iTexId1 = Utils.bindBitmap(bitmap);
      //  iTexId1 = Utils.LoadTexture(curView, paths.get(i));
