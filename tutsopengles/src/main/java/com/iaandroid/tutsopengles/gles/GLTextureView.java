...
package com.iaandroid.tutsopengles.gles;
...
public class GLTextureView extends TextureView implements TextureView.SurfaceTextureListener {
     ...
     * not normally called or subclassed by clients of GLSurfaceView.
     */
    public void surfaceRedrawNeededAsync(SurfaceTexture texture, Runnable finishDrawing) {
        if (mGLThread != null) {
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int width, int height) {
        ...
        surfaceChanged(surfaceTexture, 0, width, height);
    }
            ...
            try {
                ...
                while (true) {
                    ...
                    if (createEglContext) {
                        ...
                        if (view != null) {
                            try {
                                Log.w("GLThreadTRACE", "onSurfaceCreated");
                                view.mRenderer.onSurfaceCreated(gl, mEglHelper.mEglConfig);
                            } finally {
                                Log.w("GLThreadTRACE", "onSurfaceCreatedEnd");
                            }
                        }
                    ...
                    if (sizeChanged) {
                        ...
                        if (view != null) {
                            try {
                                Log.w("GLThreadTRACE", "onSurfaceChanged");
                                view.mRenderer.onSurfaceChanged(gl, w, h);
                            } finally {
                                Log.w("GLThreadTRACE", "onSurfaceChangedEnd");
                            }
                        }
                        sizeChanged = false;
                    }
