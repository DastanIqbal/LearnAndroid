...
public class TextureViewGLWrapper implements SurfaceTexture.OnFrameAvailableListener, TextureView.SurfaceTextureListener {
    ...
    private void configure() {
        ...
        eglSurfaceTexture.setOnFrameAvailableListener(this);
